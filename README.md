...
An API key is required to use {fdic}. Register for a free personal key
at the [United States Government’s Open Data
Portal](https://api.data.gov/signup/), which allows up to 1,000 requests
per hour.
